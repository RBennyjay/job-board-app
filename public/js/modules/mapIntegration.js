...
// 🚨 Reset the filterCenter back to the default Lagos coordinates
...
// ❌ OLD BROKEN CODE: This was outside the function and tried to use 
// the unassigned global 'map' variable. It is now correctly moved above.
...
export function plotJobMarkers(jobs) {
    ...
    // Optionally update map bounds to fit all new markers here if needed
